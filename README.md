<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=videoclaw">
    <img src="docs/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=videoclaw)** 是全模态 AI 推理平台，为 VideoClaw 提供 LLM（剧本生成）和视频生成（Kling、Seedance、Wan2、Veo）所需的一站式 API，统一 OpenAI 兼容接入。[查看全部模型](https://www.atlascloud.ai/models) · [Coding Plan](https://www.atlascloud.ai/console/coding-plan)
